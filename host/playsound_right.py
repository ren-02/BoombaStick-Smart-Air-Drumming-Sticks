"""
BoombaStick - Host Sound Player (Right Stick)

Receives drum hit events over serial from the right BoombaStick
and plays the corresponding drum sample using pygame.

Usage:
    1. Update COMPORT to match your Arduino's serial port.
    2. Run: python playsound_right.py
"""
...
try:
    ...
    print(f"\n--- ERROR ---")
    print(f"Could not open serial port {COMPORT}.")
    print("Is the device plugged in? Is the correct COM port selected?")
    print(f"Details: {e}")
    print("Exiting.")
    exit()
